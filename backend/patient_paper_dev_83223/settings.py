"""
Django settings for patient_paper_dev_83223 project.
...
ROOT_URLCONF = 'patient_paper_dev_83223.urls'
...
WSGI_APPLICATION = 'patient_paper_dev_83223.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patient_paper_dev_83223 API",
    "DESCRIPTION": "API documentation for patient_paper_dev_83223 App",
    "VERSION": "v1",
}
